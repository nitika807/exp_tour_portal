...
<link rel="stylesheet" type="text/css" href="styles/signup_responsive.css">
</head>
<body>
		...
		<div class="menu_inner menu_mm">
			<div class="menu menu_mm">
				...
				<ul class="menu_list menu_mm">
					...
					<li class="menu_item menu_mm"><a href="contact.php">Contact</a></li><?php 
								if(!isset($_SESSION['customer_email'])){
						...
						<div class="home_content_inner">
							...
							<div class="home_breadcrumbs">
								<ul class="home_breadcrumbs_list">
									...
									<li class="home_breadcrumb">Sign up</li>
								</ul>
							</div>
						</div>
					</div>
	...
	<div class="contact">
		<div class="container">
			<div class="row">
				...
				<div class="text-center" style="background:#ebe6d8;"><h3>Already have an account?</br> <a href="checkout.php">Sign in</a></h3></div></br>
		<h3> Create an Acccount </h3></br>	
		<h4>After creating an account, you'll be able to book your tours, track the confirmation and also do not forget to rate our services once you finished the tour.</h4><br>
<div class="signup-form">
<form action="signup.php" method="post" enctype="multipart/form-data">
        <div class="form-group">
			<div class="row">
			
				<div class="col"><label>First Name:</label><input type="text" class="form-control" name="c_fname" placeholder="First Name" required="required"></div>
				<div class="col"><label>Last Name:</label><input type="text" class="form-control" name="c_lname" placeholder="Last Name" required="required"></div>
			</div>        	
        </div>
		<div class="form-group">
		<div class="row">
				<div class="col"><label>Email:</label><input type="email" class="form-control" name="c_email" placeholder="Email" required="required"></div>
				</div></div>
		<div class="form-group">
        <label>Select Country:</label>
            <select id="country" name="c_country" class="form-control" required="required">
		...
		<div class="form-group">
			...
			<div class="row">
				<div class="col"><select name="c_contact_code" id="" class="form-control">
		...
		<div class="col"><input type="text" class="form-control" name="c_contact" placeholder="Phone No." required="required" ></div>
		</div>
		</div>
		</div>
		<div class="form-group">
            <label>Enter Password:</label><input type="password" class="form-control" name="c_password" id="password" placeholder="Password" required="required" onkeyup='check();'>
        </div>
		<div class="form-group">
            <label>Confirm Password:</label><input type="password" class="form-control" name="c_cpassword" id="confirm_password" placeholder="Confirm Password" required="required" onkeyup='check();'>
        <span id='message'></span>
		</div>  
		<!--<div class="form-group">
            <label>Upload Image:</label><input type="file" class="form-control" name="c_image" placeholder="Upload Picture" required="required" >
        
		</div>-->
        <div class="form-group">
			<label class="checkbox-inline"><input type="checkbox" name="c_consent" required="required"> I accept the <a href="#">Terms of Use</a> &amp; <a href="#">Privacy Policy</a></label>
		</div>
		<div class="form-group">
            <input type="submit" name="register" class="btn btn-success btn-lg btn-block" value="Register Now">
        </div>
    </form>
...
if(isset($_POST['register'])){
	...
	$c_contact_code = $_POST['c_contact_code'];
	...
	//$c_image_type = $_FILES['c_image']['type'];
	...
	if (filter_var($c_email, FILTER_VALIDATE_EMAIL)) {
		$slquery = "select 1 from customers where customer_email = '$c_email' ";
		$selectresult = mysqli_query($con, $slquery);
			...
			if ($c_password === $c_cpassword){
				//if($c_image_type == "image/jpeg" or $c_image_type == "image/png" or $c_image_type == "image/gif"){
				//if($c_image_size <= 150000 && $c_image_size >= 100000){
					//	move_uploaded_file($c_image_tmp, "customer/customer_photos/$c_image");
					
						//}		
				//else {
					
				//	echo "<script>alert('Please upload image upto 150kb only.')</script>";
					//exit();
				//}
	//}
	//else{
	...
	$insert_customer = "insert into customers (customer_fname, customer_lname, customer_email, customer_c_code ,customer_contact, customer_country, customer_pass, customer_confpass, customer_ip, customer_consent)
values ('$c_fname', '$c_lname' , '$c_email', '$c_contact_code' ,'$c_contact', '$c_country', '$c_password', '$c_cpassword', '$c_ip', '$c_consent')";
    ...
    echo "<script>alert('$c_email is not a valid email address.')</script>";
}
