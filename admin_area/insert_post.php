		...
		<div class="container">
			<div class="row">
				<div class="col"></br>
					...
					<div class="col"><label>Tour Start Date: </label><input type="date" name="sdate" id="start" min="<?php echo date('Y-m-d'); ?>" class="form-control" placeholder="Start Date" required></div>
					<div class="col"><label>Tour End Date: </label><input type="date" name="edate" id="end" class="form-control" placeholder="End Date" required></div>
					</div>
					</div>
					<!--<div class="form-group">
					<div class="row">
					
					<div class="col"><label>Booking Start Date: </label><input type="date" name="bsdate" id="start" min="<?php echo date('Y-m-d'); ?>" class="form-control" placeholder="Start Date" required></div>
					<div class="col"><label>Booking End Date: </label><input type="date" name="bedate" id="end" class="form-control" placeholder="End Date" required></div>
					</div>
					</div>-->
					<div class="form-group">
						<label>Price:</label>
...
if(isset($_POST['submit'])){
	...
	$bsdate = date('Y-m-d', strtotime($_POST['bsdate']));
	$bedate = date('Y-m-d', strtotime($_POST['bedate']));
	$status =  'on';
	...
	$query = "insert into post(post_title, post_desc, post_price, post_people, post_hotel, post_images, post_include, post_ninclude, post_date, cat_id, post_keywords, sdate, edate, booking_start, booking_end, status) 
	values('$title','$description','$price','$people','$hotel_rating','$images_name', '$inclusion','$exclusion', NOW(),'$category', '$keywords','$sdate', '$edate','$bsdate', '$bedate', '$status')";
