					...
					<div class="header_container d-flex flex-row align-items-center justify-content-start">
						...
						<nav class="main_nav ml-auto">
							<ul class="main_nav_list">
								...
								<li class="main_nav_item"><a href="customer/my_account.php">My Account</a><ul><?php 
								if(!isset($_SESSION['customer_email'])){
								echo "<li style='display:none'><a class='dropdown' href='checkout.php'>My Orders</a></li>";
								}
								else{
								...
								if(!isset($_SESSION['customer_email'])){
								echo "<li style='display:none'><a class='dropdown' href='checkout.php'>Edit Account</a></li>";
								}
								else{
									echo "<li ><a class='dropdown' href = 'customer/my_account.php?edit_account'> Edit Account</a></li>";
								}
								if(!isset($_SESSION['customer_email'])){
								echo "<li style='display:none'><a class='dropdown' href='checkout.php'>Change Password</a></li>";
								}
								else{
									echo "<li ><a class='dropdown' href = 'customer/my_account.php?change_pass'> Change Password</a></li>";
								}
								if(!isset($_SESSION['customer_email'])){
								echo "<li style='display:none'><a class='dropdown' href='checkout.php'>Delete Account</a></li>";
								}
								else{
		...
		<div class="menu_inner menu_mm">
			<div class="menu menu_mm">
				...
				<ul class="menu_list menu_mm">
					...
					<li class="menu_item menu_mm"><a href="customer/my_account.php">My Account</a><ul><?php 
								if(!isset($_SESSION['customer_email'])){
